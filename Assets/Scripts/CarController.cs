...
public class CarController : MonoBehaviour
{
    ...
    {
        if (currentSteerAngle > -30 && currentSteerAngle < 30 && horizontalInput > 0)
        {
            //rule.Rotate(Vector3.up, horizontalInput * maxSteerAngle);
            Vector3 thisLRotation = rule.transform.localEulerAngles;
            rule.transform.localEulerAngles = new Vector3(thisLRotation.x, horizontalInput * maxSteerAngle, thisLRotation.z);
        }
    }
